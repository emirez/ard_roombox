...
float bme_s::getTemperature(void)
{
  int32_t var1, var2;
...
uint32_t bme_s::getPressure(void)
{
  int64_t var1, var2, p;
...
uint32_t bme_s::getHumidity(void)
{
...
float bme_s::calcAltitude(float pressure)
{
...
uint8_t bme_s::BME280Read8(uint8_t reg)
{
...
uint16_t bme_s::BME280Read16(uint8_t reg)
{
  uint8_t msb, lsb;
...
uint16_t bme_s::BME280Read16LE(uint8_t reg)
{
  uint16_t data = BME280Read16(reg);
  return (data >> 8) | (data << 8);
}

int16_t bme_s::BME280ReadS16(uint8_t reg)
{
  return (int16_t)BME280Read16(reg);
}

int16_t bme_s::BME280ReadS16LE(uint8_t reg)
{
  return (int16_t)BME280Read16LE(reg);
}

uint32_t bme_s::BME280Read24(uint8_t reg)
{
  uint32_t data;
...
void bme_s::writeRegister(uint8_t reg, uint8_t val)
{
