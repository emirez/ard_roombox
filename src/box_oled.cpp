...
void oled_s::sendCommand(unsigned char command)
{
    Wire.beginTransmission(oled_s_Address); // begin I2C communication
    Wire.write(oled_s_Command_Mode);    // Set OLED Command mode
    Wire.write(command);
    Wire.endTransmission();                    // End I2C communication
}

void oled_s::setContrastLevel(unsigned char ContrastLevel)
{
    sendCommand(oled_s_Set_ContrastLevel_Cmd);
    sendCommand(ContrastLevel);
}

void oled_s::setHorizontalMode()
{
...
void oled_s::setVerticalMode()
{
    sendCommand(0xA0); // remap to
    sendCommand(0x46); // Vertical mode
}

void oled_s::setTextXY(unsigned char Row, unsigned char Column)
{
    //Column Address
    sendCommand(0x15);             /* Set Column Address */
...
void oled_s::sendData(unsigned char Data)
{
    Wire.beginTransmission(oled_s_Address); // begin I2C transmission
    Wire.write(oled_s_Data_Mode);            // data mode
    Wire.write(Data);
    Wire.endTransmission();                    // stop I2C transmission
}

void oled_s::setGrayLevel(unsigned char grayLevel)
{
    grayH = (grayLevel << 4) & 0xF0;
    grayL =  grayLevel & 0x0F;
}

void oled_s::putChar(unsigned char C)
{
...
void oled_s::putString(const char *String)
{
    unsigned char i=0;
    while(String[i])
    {
...
unsigned char oled_s::putNumber(long long_num)
{
...
void oled_s::drawBitmap(const unsigned char *bitmaparray,int bytes)
{
...
void oled_s::setHorizontalScrollProperties(bool direction,unsigned char startRow, unsigned char endRow,unsigned char startColumn, unsigned char endColumn, unsigned char scrollSpeed)
{
    /*
...
void oled_s::activateScroll()
{
    sendCommand(oled_s_Activate_Scroll_Cmd);
}

void oled_s::deactivateScroll()
{
    sendCommand(oled_s_Dectivate_Scroll_Cmd);
}

void oled_s::setNormalDisplay()
{
    sendCommand(oled_s_Normal_Display_Cmd);
}

void oled_s::setInverseDisplay()
{
    sendCommand(oled_s_Inverse_Display_Cmd);
}
