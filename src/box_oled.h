...
#define oled_s_Address               0x3c
#define oled_s_Command_Mode          0x80
#define oled_s_Data_Mode             0x40

#define oled_s_Display_Off_Cmd       0xAE
#define oled_s_Display_On_Cmd        0xAF

#define oled_s_Normal_Display_Cmd    0xA4
#define oled_s_Inverse_Display_Cmd   0xA7
#define oled_s_Activate_Scroll_Cmd   0x2F
#define oled_s_Dectivate_Scroll_Cmd  0x2E
#define oled_s_Set_ContrastLevel_Cmd 0x81
